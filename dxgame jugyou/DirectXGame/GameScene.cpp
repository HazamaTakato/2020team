...
void GameScene::Initialize(DirectXCommon* dxCommon, Input* input, Audio * audio)
{
	...
	//シーン関連の画像
	{
		Sprite::LoadTexture(4, L"Resources/title1.png");
		Sprite::LoadTexture(5, L"Resources/ending1.png");
		Sprite::LoadTexture(6, L"Resources/gameover.png");

		title = Sprite::Create(4, { 0.0f,0.0f });
		ending = Sprite::Create(5, { 0.0f,0.0f });
